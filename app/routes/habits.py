    ...
    <body class="relative bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 text-slate-800">
      ...
      <header class="bg-white/10 backdrop-blur-md border-b border-white/20 text-slate-900">
        <div class="max-w-5xl mx-auto px-4 py-6 flex items-center justify-between">
          <a href="/habits" class="text-xl font-semibold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-fuchsia-600">HabitVerse</a>
    ...
    body = """
      ...
      <div class=\"mt-3 p-6 rounded-2xl glass\"> 
        <div class=\"flex items-start justify-between\"> 
          <div> 
            <div class=\"flex items-center gap-2\"> 
              <span class=\"inline-block w-3 h-3 rounded-full\" style=\"background:%s\"></span> 
              <h1 class=\"text-2xl font-semibold\">%s</h1> 
            </div> 
            <p class=\"mt-1 text-slate-700\">%s</p> 
          </div> 
          <div class=\"text-right text-sm text-slate-600\"> 
            <div class=\"px-2 py-1 rounded-lg bg-emerald-50 text-emerald-700\">Streak: %s</div> 
            <div class=\"mt-1\">Best: %s</div> 
          </div> 
        </div> 
        <div class=\"mt-4 flex flex-wrap gap-2 text-sm\"> 
          <span class=\"px-2 py-1 rounded-full bg-white/60 border border-white/40 text-slate-700\">Kategori: %s</span> 
          <span class=\"px-2 py-1 rounded-full bg-white/60 border border-white/40 text-slate-700\">Frekuensi: %s</span> 
        </div> 
      </div> 
